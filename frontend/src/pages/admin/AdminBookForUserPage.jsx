...
export default function AdminBookForUserPage() {
  ...
  async function onBook(e) {
    ...
    try {
      await api.post(`/api/admin/users/${userId}/bookings`, {
        objectId: Number(objectId),
        startTime: st,
        endTime: et,
        bookingMode: bookingMode,
      });
      navigate(`/admin/employees/${userId}/bookings`);
    } catch (err) {
      setMessage({ type: "err", text: getErrorText(err) });
    }
  }
    ...
    <div style={{ padding: 24, maxWidth: 600 }}>
      ...
      {obj && (
        <>
          ...
          <h3>Существующие брони на {date}:</h3>
          ...
          <h3>Забронировать за сотрудником</h3>
